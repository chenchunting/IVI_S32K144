# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
# 63 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
...
uint16_t FTM_DRV_ConvertFreqToPeriodTicks(uint32_t instance,
                                          uint32_t freqencyHz);
# 64 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c" 2
...
void FTM_DRV_SetChnInputCaptureFilter(FTM_Type * const ftmBase,
                                      uint8_t channel,
                                      uint8_t value);
# 65 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c" 2
...
FTM_Type * const g_ftmBase[(4u)] = { ((FTM_Type *)(0x40038000u)), ((FTM_Type *)(0x40039000u)), ((FTM_Type *)(0x4003A000u)), ((FTM_Type *)(0x40026000u)) };


const IRQn_Type g_ftmIrqId[(4u)][(8U)] = { { FTM0_Ch0_Ch1_IRQn, FTM0_Ch0_Ch1_IRQn, FTM0_Ch2_Ch3_IRQn, FTM0_Ch2_Ch3_IRQn, FTM0_Ch4_Ch5_IRQn, FTM0_Ch4_Ch5_IRQn, FTM0_Ch6_Ch7_IRQn, FTM0_Ch6_Ch7_IRQn }, { FTM1_Ch0_Ch1_IRQn, FTM1_Ch0_Ch1_IRQn, FTM1_Ch2_Ch3_IRQn, FTM1_Ch2_Ch3_IRQn, FTM1_Ch4_Ch5_IRQn, FTM1_Ch4_Ch5_IRQn, FTM1_Ch6_Ch7_IRQn, FTM1_Ch6_Ch7_IRQn }, { FTM2_Ch0_Ch1_IRQn, FTM2_Ch0_Ch1_IRQn, FTM2_Ch2_Ch3_IRQn, FTM2_Ch2_Ch3_IRQn, FTM2_Ch4_Ch5_IRQn, FTM2_Ch4_Ch5_IRQn, FTM2_Ch6_Ch7_IRQn, FTM2_Ch6_Ch7_IRQn }, { FTM3_Ch0_Ch1_IRQn, FTM3_Ch0_Ch1_IRQn, FTM3_Ch2_Ch3_IRQn, FTM3_Ch2_Ch3_IRQn, FTM3_Ch4_Ch5_IRQn, FTM3_Ch4_Ch5_IRQn, FTM3_Ch6_Ch7_IRQn, FTM3_Ch6_Ch7_IRQn } };
const IRQn_Type g_ftmFaultIrqId[(4u)] = { FTM0_Fault_IRQn, FTM1_Fault_IRQn, FTM2_Fault_IRQn, FTM3_Fault_IRQn };
const IRQn_Type g_ftmOverflowIrqId[(4u)] = { FTM0_Ovf_Reload_IRQn, FTM1_Ovf_Reload_IRQn, FTM2_Ovf_Reload_IRQn, FTM3_Ovf_Reload_IRQn };
const IRQn_Type g_ftmReloadIrqId[(4u)] = { FTM0_Ovf_Reload_IRQn, FTM1_Ovf_Reload_IRQn, FTM2_Ovf_Reload_IRQn, FTM3_Ovf_Reload_IRQn };


_Bool faultDetection = 0;



ftm_state_t * ftmStatePtr[(4u)] = {((void *)0)};


static const clock_names_t g_ftmExtClockSel[(4u)][2] = {{SIM_FTM0_CLOCKSEL, FTM0_CLK},
                                                                      {SIM_FTM1_CLOCKSEL, FTM1_CLK},
                                                                      {SIM_FTM2_CLOCKSEL, FTM2_CLK},
                                                                      {SIM_FTM3_CLOCKSEL, FTM3_CLK},
# 103 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
                                                                      };
# 113 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_Init(uint32_t instance,
                      const ftm_user_config_t * info,
                      ftm_state_t * state)
{
    DevAssert(instance < (4u));
    DevAssert(info != ((void *)0));
    ...
    if (ftmStatePtr[instance] != ((void *)0))
    {
        status = STATUS_ERROR;
    }
    else
    {
        ...
        for (index = 0U; index < (8U); index++)
        {
            ...
            state->channelsCallbacksParams[index] = ((void *)0);
            state->channelsCallbacks[index] = ((void *)0);
        }
        ...
        DevAssert(state->ftmSourceClockFrequency > 0U);
    }
    ...
    if (STATUS_SUCCESS == status)
    {
        ...
        {
            FTM_DRV_SetTimerOverflowInt(ftmBase, 1);
            INT_SYS_EnableIRQ(g_ftmOverflowIrqId[instance]);
        }
        else
        {
            FTM_DRV_SetTimerOverflowInt(ftmBase, 0);
...
# 191 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_Deinit(uint32_t instance)
{
    DevAssert(instance < (4u));
    FTM_Type * ftmBase = g_ftmBase[instance];
    ...
    FTM_DRV_Reset(ftmBase);
    ftmStatePtr[instance] = ((void *)0);

    return STATUS_SUCCESS;
}
# 211 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_MaskOutputChannels(uint32_t instance,
                                    uint32_t channelsMask,
                                    _Bool softwareTrigger)
{
...
# 235 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetInitialCounterValue(uint32_t instance,
                                        uint16_t counterValue,
                                        _Bool softwareTrigger)
{
...
# 259 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetHalfCycleReloadPoint(uint32_t instance,
                                         uint16_t reloadPoint,
                                         _Bool softwareTrigger)
{
...
# 285 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetSoftOutChnValue(uint32_t instance,
                                    uint8_t channelsValues,
                                    _Bool softwareTrigger)
{
...
# 308 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetSoftwareOutputChannelControl(uint32_t instance,
                                                 uint8_t channelsMask,
                                                 _Bool softwareTrigger)
{
...
# 331 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetAllChnSoftwareOutputControl(uint32_t instance,
                                                uint8_t channelMask,
                                                uint8_t channelValueMask)
{
...
# 354 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetInvertingControl(uint32_t instance,
                                     uint8_t channelsPairMask,
                                     _Bool softwareTrigger)
{
...
# 377 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetModuloCounterValue(uint32_t instance,
                                       uint16_t counterValue,
                                       _Bool softwareTrigger)
{
...
# 401 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetOutputlevel(uint32_t instance,
                                uint8_t channel,
                                uint8_t level)
{
...
# 425 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_SetSync(uint32_t instance,
                         const ftm_pwm_sync_t * param)
{
    DevAssert(instance < (4u));
    ...
    _Bool hardwareSync = param->hardwareSync0 || param->hardwareSync1 || param->hardwareSync2;


    if ((param->softwareSync && hardwareSync) || (1 != (param->softwareSync || hardwareSync)))
    {
    ...
    else if (param->softwareSync)
    {
        ...
        FTM_DRV_SetOutmaskSoftwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetInvctrlSoftwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetSwoctrlSoftwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetModCntinCvSoftwareSyncModeCmd(ftmBase, 1);
    ...
    else
    {
        ...
        FTM_DRV_SetOutmaskHardwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetInvctrlHardwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetSwoctrlHardwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetModCntinCvHardwareSyncModeCmd(ftmBase, 1);

        FTM_DRV_SetCounterHardwareSyncModeCmd(ftmBase, (_Bool)param->syncPoint);
    }

    if (STATUS_SUCCESS == retStatus)
    {

        FTM_DRV_SetPwmSyncModeCmd(ftmBase, 1);
        ...
        FTM_DRV_SetOutmaskPwmSyncModeCmd(ftmBase, (_Bool)param->maskRegSync);
...
# 501 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
status_t FTM_DRV_EnableInterrupts(uint32_t instance,
                                  uint32_t interruptMask)
{
    DevAssert(instance < (4u));
    ...
    {
        FTM_DRV_SetReIntEnabledCmd(ftmBase, 1);
...
# 552 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
void FTM_DRV_DisableInterrupts(uint32_t instance,
                               uint32_t interruptMask)
{
    DevAssert(instance < (4u));
    ...
    if ((interruptMask & (uint32_t)FTM_RELOAD_INT_ENABLE) != 0x0U)
    {
        FTM_DRV_SetReIntEnabledCmd(ftmBase, 0);
...
# 601 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
uint32_t FTM_DRV_GetEnabledInterrupts(uint32_t instance)
{
    DevAssert(instance < (4u));
    ...
    if (FTM_DRV_IsOverflowIntEnabled(ftmBase) == 1)
    {
        enabledInterrupts |= (uint32_t)FTM_TIME_OVER_FLOW_INT_ENABLE;
    }


    if (FTM_DRV_IsFaultIntEnabled(ftmBase) == 1)
    {
        enabledInterrupts |= (uint32_t)FTM_FAULT_INT_ENABLE;
    }


    if (FTM_DRV_IsReloadIntEnabled(ftmBase) == 1)
    {
    ...
    {
        channel--;
        if (FTM_DRV_IsChnIntEnabled(ftmBase, channel) == 1)
        {
...
# 647 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
uint32_t FTM_DRV_GetStatusFlags(uint32_t instance)
{
    DevAssert(instance < (4u));
    FTM_Type const * ftmBase = g_ftmBase[instance];
    ...
    if (FTM_DRV_HasTimerOverflowed(ftmBase) == 1)
    {
    ...
    if (FTM_DRV_GetReloadFlag(ftmBase) == 1)
    {
        statusFlags |= (uint32_t)FTM_RELOAD_FLAG;
    }


    if (FTM_DRV_IsChnTriggerGenerated(ftmBase) == 1)
    {
    ...
    {
        if (FTM_DRV_HasChnEventOccurred(ftmBase, channel) == 1)
        {
...
# 697 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
void FTM_DRV_ClearStatusFlags(uint32_t instance,
                              uint32_t flagMask)
{
    DevAssert(instance < (4u));
...
# 749 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
uint32_t FTM_DRV_GetFrequency(uint32_t instance)
{
    DevAssert(instance < (4u));
    FTM_Type const * ftmBase = g_ftmBase[instance];
    ...
    (void)returnCode;
    DevAssert(returnCode == STATUS_SUCCESS);

    return (uint32_t)(frequency / clkPs);
}
# 804 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/ftm/ftm_common.c"
uint16_t FTM_DRV_ConvertFreqToPeriodTicks(uint32_t instance,
                                          uint32_t freqencyHz)
{
    DevAssert(instance < (4u));
    DevAssert(freqencyHz != 0U);
    uint32_t uFTMhz;
    const ftm_state_t * state = ftmStatePtr[instance];

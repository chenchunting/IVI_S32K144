...
uint8_t slaveTxBuffer[8] = { 0x0, 0x1, 0x02, 0x3, 0x4, 0x5, 0x6, 0x7};
uint8_t slaveRxBuffer[8] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0};
# 51 "../Sources/main.c"
void i2c1_SlaveCallback0(i2c_slave_event_t slaveEvent, void *userData) {
 ...
 if (slaveEvent == I2C_SLAVE_EVENT_RX_REQ)
  I2C_SlaveSetRxBuffer((uint8_t) instance, slaveRxBuffer, 8);
 if (slaveEvent == I2C_SLAVE_EVENT_TX_REQ)
  I2C_SlaveSetTxBuffer((uint8_t) instance, slaveTxBuffer, 8);
}
...
int main(void)
{
 ...
 uint8_t masterTxBuffer[8];

 uint8_t cnt;
 _Bool isTransferOk = 1;

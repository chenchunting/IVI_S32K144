...
# 58 "D:/NXP/SourceCode/s32k144/s32k144/Generated_Code/clockMan1.h" 2
...
# 59 "D:/NXP/SourceCode/s32k144/s32k144/Generated_Code/clockMan1.h" 2
...
void uart_init(void)
{
 ...
 UART_Init((0U), &lpuart0_uart_Config0);
 UART_Init((1U), &lpuart1_uart_Config0);
}

void can_init(void)
{
    CAN_Init((0U), &can_pal0_Config0);
    CAN_Init((1U), &can_pal1_Config0);
    ...
    CAN_ConfigRxBuff((0U), (0UL), &buffCfg, 0x602);
    CAN_ConfigTxBuff((0U), (1UL), &buffCfg);
    CAN_ConfigRxBuff((1U), (0UL), &buffCfg, 0x602);
    CAN_ConfigTxBuff((1U), (1UL), &buffCfg);
}

void ledsrip_spi_init(void)
{
 EDMA_DRV_Init(&dmaController1_State, &dmaController1_InitConfig0, edmaChnStateArray, edmaChnConfigArray, 2U);
 LPSPI_DRV_MasterInit((0U), &SendState, &Send_MasterConfig0);
}

void wdg_init(void)
{
 WDG_Init(WDG_OVER_WDOG_INSTANCE, &wdg_pal1_Config0);
}

void pwm_init(void)
{
 ftm_state_t ftmStateStruct;
 FTM_DRV_Init(0U, &flexTimer_pwm1_InitConfig, &ftmStateStruct);
 FTM_DRV_InitPwm(0U, &flexTimer_pwm1_PwmConfig);

}

void hx8880_spi_init(void)
{
 LPSPI_DRV_MasterInit((1U), &Send1State, &Send1_MasterConfig0);
